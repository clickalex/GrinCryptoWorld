  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/85 backdrop-blur-lg dark:border-white/10 dark:bg-[#0b1015]/85">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4">
        ...
        <button onClick={() => window.dispatchEvent(new KeyboardEvent('keydown', { key: 'k', ctrlKey: true }))} className="hidden items-center gap-2 rounded-lg border border-slate-200 px-2.5 py-1.5 text-xs text-slate-400 hover:border-brand-500/40 hover:text-brand-500 dark:border-white/10 md:flex" title="Open command palette (Ctrl+K)">
          Quick jump <kbd className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-[10px] dark:bg-white/10">Ctrl K</kbd>
        </button>
